...
At this point (after about 1 minute of reasoning), the participant might feel confident enough to submit an early guess.

> [Submits early guess: “None of the cones are upright”]

Even after submitting this early idea, they continue exploring:

>  “Okay, that seems to work… but I want to be sure. Maybe there’s still something I’m missing.”
>
>  “Could it be about the number of cones total instead? I should double-check Panel C, maybe one upright cone doesn’t always break the rule…”
